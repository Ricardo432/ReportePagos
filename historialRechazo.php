...
<html lang="es">
  <head>
    ...
    <title>Lista de Pagos Rechazados</title>
    ...
    <div class="container">
      ...
      <table class="table table-hover">
        ...
        <?php include 'conexion.php';
         $query = "SELECT * FROM pagos WHERE (Revisado='1' and Rechazado='1') and FechaRegistro between '".date('Y-m')."-1' and '".date('Y-m')."-31' order by FechaAceptado desc";
