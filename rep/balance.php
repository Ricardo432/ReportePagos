...
<tr >
    <td rowspan="2" ><img src="http://countryvillahermosa.org/img/logo1.jpeg" style="width:150px; height:60px;"><b> Fraccionamiento el Country</b></td>
    ...
    <tr>
        <td colspan="2" style=""><b>Balance general de ingresos y egresos
del mes de mayo del a&#241;o del periodo 1 - 31</b></td>
    </tr>
    <tr>
       
         <td>Saldo Global inicial al dia 1&#176; de este mes: <?php echo money_format('%(#2n',($inicio)  ) . "\n"; ?> </td>
    </tr>
    <tr>
    ...
    <tr>
        <td >Con un total de reportes validados de : <?php echo $nPagos; ?></td>
    </tr>
    ...
    <tr>
        <td>Saldo Global: <?php echo money_format('%(#2n',(($inicio+$en-$sum))  ) . "\n"; ?></td>
    </tr>
</table>
