...
<div class="w3-padding-large" id="main">
    ...
    <h4><small>PUBLICACIONES RESIENTES</small></h4>
     <?php include 'conexion.php'; $query="SELECT * from noticias where Aceptado='1'"; 
     ...
     ?>
      ...
      <form role="form" method="post" action="comentario.php">
      ...
      <div class="row">
       <?php $query2="SELECT * from comentarios where Aceptado='1' and idNoticia='".$line['idNoticia']."' "; 
      ...
      while ($line3 = mysql_fetch_array($result3,MYSQL_ASSOC)) { echo $line3['Imagen']; }?>" class="img-circle" height="65" width="65" alt="Avatar">
        ...
        <div class="col-sm-10">
          <h4><?php $query3="SELECT * from residente where idResidente='".$line2['idResidente']."'"; 
      $result3 = mysql_query($query3);
